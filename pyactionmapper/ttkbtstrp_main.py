...
class mapper(ttk.Frame):
    ...
    def __init__(self, master_window, selected_profile=None):
        ...
        self.setup_display(master_window)
        self.switch_profile(self.selected_profile)
        # main_window is defined inside setup_display, there is clearly an incorrect order of operations here.
    ...
    def setup_display(self, master_window):
        ...
        self.profile_menu = ttk.Menu(self.menubar, tearoff=0)
        ...
        # '''
        helpmenu = ttk.Menu(self.menubar, tearoff=0)
        ...
        for s_idx, section_name in enumerate(self.tab_names):
            ...
            for a_idx, action in enumerate(section["action"]):
                ...
                for col, key in enumerate(ky_dct):
                    ...
                    e = ttk.Entry(self.section_tabs[s_idx], textvariable=tvar)
...
if __name__ == '__main__':
    app = ttk.Window("PyActionmapper", "mwll_1", resizable=(False, False))
    mapper = mapper(app)
